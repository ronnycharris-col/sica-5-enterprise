...
const badgeEstado =
    ...
    <button
        class="btn btnRojo"
        onclick="eliminarEmpleado('${registro.id}')">
...
window.editarEmpleado = async function(id){
    ...
    try{
        ...
        document.getElementById("btnGuardarEmpleado").innerHTML =
            "✏️ Actualizar";
        ...
        const btnDesactivar =
            document.getElementById("btnDesactivarEmpleado");

        if(btnDesactivar){

            if((empleado.estado || "Activo")==="Activo"){
                ...
                btnDesactivar.disabled = false;
btnDesactivar.innerHTML = "✅ Reactivar";
        ...
        alert("No fue posible cargar el empleado.");
...
async function desactivarEmpleado(){
    ...
    if(idEmpleadoActual===null){
        ...
        alert("Primero seleccione un empleado.");
        return;
    ...
    try{
        ...
        const referencia = doc(db,"empleados",idEmpleadoActual);
